...
defaultproperties
{
	...
	bCanPickupInventory=true
        ...
        //Adjust jump acceleration, base acceleration, ground speed, and amount of air control, respectively.
        //These attributes would probably be better suited being set in the editor -DMR
        JumpZ=840.0;
	AccelRate=1900.0
	GroundSpeed=830.0
	AirControl=+0.4
